...
def train(args, model, criterion, postprocessors, device):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        print(f"Epoch {epoch + 1}, Training Loss: {train_stats['loss']}")
        ...
        val_loss = pubmed_stats['average_val_loss']
        ...
        # Step the  ReduceLROnPlateau learning rate scheduler with the validation loss
        ...
        if (epoch+1) % args.checkpoint_freq == 0:
            ...
            #plot_losses(model_save_path_epoch)
